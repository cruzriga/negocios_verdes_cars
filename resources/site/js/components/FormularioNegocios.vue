      ...
      <q-card class="my-card q-ma-md">
        ...
        <q-card-section>
          <masonry :cols="{default: 2, 1000: 2, 700: 1}" :gutter="10">
            <div cass="justify-center items-center">
            ...
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.descripcion.data" :label="formulario.descripcion.label" type="textarea"
                         counter maxlength="500" :rules="formulario.descripcion.rules"
            ...
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.nombreempresa.data" label="Nombre De la Empresa" type="text" counter
                         maxlength="200" :rules="formulario.nombreempresa.rules">
                </q-input>
            ...
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.representantelegal.data" label="Representante Legal" type="text" counter
                         maxlength="200" :rules="formulario.representantelegal.rules">
                </q-input>
              </div>
            </div>
            <div>
                    ...
                    >
                      ...
                      <q-item-section>
                        ...
                        <q-item-label caption>
                          {{ formulario.categoria.data != null ? formulario.categoria.data.nombre : '' }}
                        </q-item-label>
                      </q-item-section>
                    </q-item>
                  </template>
              ...
              <q-select
                  v-if="formulario.subcategoria.data!=null && this.$store.state.formulario.categoria.tiposubcategorias.filter(post => { return post.idsubcategoria == formulario.subcategoria.data.idsubcategoria}).length >1 "
                ...
                <template v-slot:option="scope">
                  ...
                  >
                    ...
                    <q-item-section>
                      <q-item-label v-html="scope.opt.nombre"/>
                      <q-item-label caption>
                        {{ formulario.categoria.data.nombre + ' - ' + formulario.subcategoria.data.nombre }}
                      </q-item-label>
                    </q-item-section>
                  </q-item>
                </template>
            ...
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.telefono.data" label="Telefono" counter maxlength="12" :dense="dense"
                         :rules="formulario.telefono.rules">
            ...
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.direccion.data" label="Direccion" type="text" counter maxlength="200"
                         :dense="dense" :rules="formulario.direccion.rules">
                  <template v-slot:prepend>
            ...
            <q-card class="my-card q-ma-md">
              ...
              <q-card-section class="q-pa-none">
                ...
                <q-list bordered separator>
                  <q-item
                      v-for="(applicant, counter) in formulario.productos.filter(post => { return post.activo == 1})"
                      v-bind:key="counter"
                      class="row justify-center items-center">
                    <q-item-section top>
                      <q-item-label lines="1">
                        <q-input v-model="applicant.nombre" label="Nombrel del producto" type="text"
                      ...
                      <q-item-label lines="1">
                        <q-input v-model="applicant.descripcion" label="Descripción" type="text"
                                 :rules="[ val => val && val.length > 0 || 'Campo vacio']">
                        </q-input>
                      </q-item-label>
                      <q-item-label class="text-right">
                        <q-btn outline rounded color="negative" v-if="counter>=1" @click="deleteVisa(counter)" icon="delete"
                               label="Eliminar" no-caps/>
                      </q-item-label>
                    </q-item-section>
                  </q-item>
                </q-list>
        ...
        <q-card-section>
          <masonry :cols="{default: 2, 1000: 2, 700: 1}" :gutter="10">
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.twitter.data" label="Twitter" :dense="dense"
                         :rules="formulario.twitter.rules" hint="Opcional">
                  <template v-slot:prepend>
                    <!-- <q-icon name="fab fa-twitter-square" /> -->
            ...
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.facebook.data" label="Facebook" :dense="dense"
                         :rules="formulario.facebook.rules"
                         hint="Opcional"
                >
                  <template v-slot:prepend>
            ...
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.instagram.data" label="Instagram" :dense="dense"
                         :rules="formulario.instagram.rules" hint="Opcional">
                  <template v-slot:prepend>
            ...
            <div class="row justify-center items-center">
              ...
              <div class="col-12 col-md-9" style="width: 100%;">
                <q-input v-model="formulario.linkvideo.data" label="Link Video YouTube" :dense="dense"
                         :rules="formulario.twitter.rules" hint="Opcional">
                  <template v-slot:prepend>
        ...
        <q-card class="my-card q-ma-md">
          ...
          <q-card-section>
            <div v-for="(item, count) in anexofile" v-bind:key="count" class="row justify-center items-center">
              <q-uploader
                  ...
                  :hint="item.hint" :color="item.color"
              >
                <template v-slot:header="scope">
                  <div class="row no-wrap items-center q-pa-sm q-gutter-xs">
                    ...
                    <div v-if="item.urlActual!=null">
                      <a style="margin-right: 20px;" rel="noopener noreferrer" target="_blank" id="btn-1615192830423"
                         :href="root_url+item.urlActual" class="sppb-btn sppb-btn-round">
                        <q-icon size="1.4rem" :name="'img:media/iconssvg/'+item.urlActual.split('.').pop()+'.svg'"/>
                      </a>
                    </div>
                    <a style="margin-right: 20px;" rel="noopener noreferrer" target="_blank" id="btn-1615192830423"
                       :href="root_url+'media/attachments/2021/03/08/'+item.doc" class="sppb-btn  sppb-btn-round">
          ...
          <div class="q-pa-md">
            ...
            <div style="padding-left: 55px">
              (<a
                href="https://corpoguajira.gov.co/wp/wp-content/uploads/2020/11/RESOLUCION-POLITICA-DE-TRATAMIENTO-DE-DATOS-NUEVO-7-DE-OCT-DE-2020-1.pdf">Política
              de tratamientos de datos </a>)
            </div>
          </div>
        </q-card>
        <q-card class="my-card q-ma-md">
